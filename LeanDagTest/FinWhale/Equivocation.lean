...
example : slotBlocks (Sched.identity eqSlots.leader) Dequiv 0 = {0, 4} ∧ Conflicting Dequiv 0 4 := by decide
...
example : DirectCommit Dequiv 6 ∧
    slotBlocks (Sched.identity eqSlots.leader) (restrict Dequiv Vmiss isView_Vmiss) 1 = ∅ := by decide
...
block to run on. -/
example : ∀ l ∈ slotBlocks (Sched.identity eqSlots.leader) (restrict Dequiv Vmiss isView_Vmiss) 1,
...
committed. -/
example : ¬ DirectSkip (Sched.identity eqSlots.leader) (restrict Dequiv Vmiss isView_Vmiss) 1 := by decide
