...
example : DirectCommit Dequiv 6 ∧
    slotBlocks (Slots.identity eqSlots.leader) (restrict Dequiv Vmiss isView_Vmiss) 1 = ∅ := by decide
...
block to run on. -/
example : ∀ l ∈ slotBlocks (Slots.identity eqSlots.leader) (restrict Dequiv Vmiss isView_Vmiss) 1,
...
committed. -/
example : ¬ DirectSkip (Slots.identity eqSlots.leader) (restrict Dequiv Vmiss isView_Vmiss) 1 := by decide
